        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            <form id="formData" enctype="multipart/form-data">
              ...
              <div class="row my-3">
                <div class="col-md-12">
                  <label for="image" class="col-form-label">Upload Image<?php if(isset($banner)){}else { echo "<em>*</em>"; } ?></label>

                  <input type="file" name="image" class="form-control mb-2" id="image" accept="image/*" <?php if(!isset($banner)){ echo "required"; } ?>>
...
<script>
  function get_form_data(){
    ...
    $.ajax({
      type:"POST",
      url:"{{url('admin/insertAgentBanner')}}",
      ...
      success:function(data)
      {
        if($.trim(data)=="update")
        {
          ...
          $('#end_date_error').html('');
          setTimeout(() => {
            window.location.href = "<?php echo url('admin/agentBanners'); ?>";
          }, 5000);
        }
