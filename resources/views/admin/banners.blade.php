    ...
    <div class="container-fluid p-0 ">
        ...
        <div class="col-12">
            ...
            <div class="page_title_left">
                <h4 class="f_s_30 f_w_700 text_white"><a href="javascript:history.back()" class="back_button" title="Back"><i class="fa fa-arrow-left"></i></a> Banners</h4>
                    ...
                    <table class="table table-striped" id="example">
                        ...
                        <tbody class="row_position">
                            ...
                            <tr id="<?php echo $banner->id; ?>">
                                ...
                                <td>{{ ++$key }}</td>
                                <td>
                                    <a href="{{ $banner->url }}" target="_blank"><img src="{{ url('public/img/banners') }}/{{ $banner->image }}" alt="Banner Image" height="50" width="50"></a>
                                </td>
                                <td>{{ $banner->name }}</td>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="{{ url('admin/update_status') }}/{{ $banner->id }}/banner" onclick="return confirm('Are you sure that you want to change status of this item ?');">
                                ...
                                <td><a href="{{ url('admin/addBanner?id=') }}{{ $banner->id }}"><i class="fa fa-edit"></i></a> | <a href="{{ url('admin/delete') }}/{{ $banner->id }}/Banner"  onclick="return confirm('Are you sure that you want to delete this item ?');"><i class="fa fa-trash text-danger"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    $('.flexSwitchCheckChecked').click(function(){
        ...
        if(confirm("Are you sure want to change this status?")){
            $.ajax({
                type:'POST',
                url:'{{url("/admin/change_banner_status")}}',
