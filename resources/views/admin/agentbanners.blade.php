        ...
        <div class="row">
            <div class="col-12">
                ...
                <li class="breadcrumb-item active">Banners</li>
                    ...
                    <a href="{{ url('admin/addAgentBanner') }}" class="white_btn3">Create</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-striped" id="example">
                        ...
                        <tbody class="row_position">
                            ...
                            <tr id="<?php echo $banner->id; ?>">
                                ...
                                <td><a href="{{ url('admin/addAgentBanner?id=') }}{{ $banner->id }}"><i class="fa fa-edit"></i></a> | <a href="{{ url('admin/deleteAgent') }}/{{ $banner->id }}/AgentBanner" onclick="return confirm('Are you sure that you want to delete this item ?');"><i class="fa fa-trash text-danger"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script type="text/javascript">
    ...
    function updateOrder(aData) {
        ...
        $.ajax({
            url: "{{url('updateAgentBannerOrder')}}",
            type: "POST",
            data: {
                allData: aData,
                _token: token
...
<script>
    $('.flexSwitchCheckChecked').click(function(){
        ...
        if(confirm("Are you sure want to change this status?")){
            $.ajax({
                type:'POST',
                url:'{{url("/admin/change_agentbanner_status")}}',
