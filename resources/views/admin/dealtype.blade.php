...
<div class="main_content_iner overly_inner ">
    <div class="container-fluid p-0 ">
        ...
        <div class="col-12">
            ...
            @endif
            <a href="{{ url('admin/adddealtype') }}" class="white_btn3">Create</a>
            </div>
        </div>
        </div>
    </div>
                    ...
                    <table class="table p-0" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{url('/admin/adddealtype?key='.base64_encode($value->id))}}"><i class="fa fa-edit"></i></a> | <a class="delete" data-id="{{$value->id}}"><i class="fa fa-trash"></i></a></td>
                            </tr>
                            @php
                            $i++
                            @endphp
...
<script>
    $('.flexSwitchCheckChecked').click(function(){
        ...
        if(confirm("Are you sure want to change this status?")){
            $.ajax({
                type:'POST',
                url:'{{url("/admin/change_dealtype_status")}}',
